  ...
  return (
    <>
      <div className="flex justify-end">
        <button
          // Кнопка открытия/закрытия формы создания абонемента
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                // Обновление имени клиента в состоянии newMembership
            ...
            <div>
              ...
              <input
                ...
                // Обновление телефона клиента в состоянии newMembership
            ...
            <div>
              ...
              <select
                ...
                // Выбор типа абонемента, обработка через внешний обработчик
            ...
            <div>
              ...
              <input
                ...
                // Преобразование значения в число и обновление цены
            ...
            <div>
              ...
              <input
                ...
                // Обновление даты начала абонемента
            ...
            <div>
              ...
              <input
                ...
                // Обновление даты окончания абонемента
            ...
            <div className="md:col-span-2 flex space-x-4">
              <button
                // Кнопка создания абонемента, вызывает внешний обработчик
